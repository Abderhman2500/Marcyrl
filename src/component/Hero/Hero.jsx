...
export default function Hero() {
  return (
    <div>
    <div className='container flex z-0'>
        <div className='tit-hero py-15'>
            <p className='p1'>SINCE 1996</p>
            <h1>Every Great Medicine Begins With <br/><span>One Vision.</span></h1>
            <p className='p2'>For nearly three decades, Marcyrl has transformed scientific research into trusted pharmaceutical solutions that improve
                millions of lives across local and international markets.</p>
                <button className='btn1'>Explore Our Story</button>
                <button className='btn2'><MdSlowMotionVideo className='icon-hero'/>Watch Manufacturing</button>
                <p className='line'></p>
        ...
        <div className="img-hero ">
            <img src={img1} alt=""className='img1-hero'/>
            <p className="shape-border"><RxVideo className='icon-hero'/></p> 
      ...
      <div className="section sticky top-0 z-10 ">
        <div className="img-section">
           <img src={img1} alt=""className='img1-section '/>
            <p className="shape-border-section"><RxVideo className='icon-section'/></p> 

        </div>   
      </div>
                {/* sticky top-20 */}
      <div className='container flex sticky top-0 z-20'>
        <div className="section grid grid-flow-col grid-rows-3 gap-4 z-1 ">
            <div className="info-bulding row-span-3 ">
                ...
                <p className='p11-bulding'>At Marcyrl, our legacy is built on the rigorous pursuit of
                    quality. We believe that pharmaceutical manufacturing is
                     ...
                     global standards are met at every stage.</p>
                     <p className='p111-bulding'>Discover Our Journey </p><MdArrowForward className='icon-bulding'/>       
            </div>

            <div className="section-img flex gap-4 mx-25 ">
              <img src={img3} alt=""className='img3'/>
              <div className="flex flex-col gap-4">
                <img src={img33} alt="" className='img33'/> 
     ...
     <div className='relative z-30'>
      ...
      <div className="section5 bg-[#030320] w-[100%] h-[1000px]">
              ...
              <div className="info-sec5 ">
                <p className='text-[white] tracking-[1.4px] py-20'>PROCESS INNOVATION</p>
                 <div className='flex justify-between'>
                     ...
                     <button className='rounded-[999px] w-[193px] h-[40px] border border-[#FFFFFF] text-[#FFFFFF] my-[-50px] cursor-[pointer]'>Tour Our Facilities</button>
                 </div>
                      <img src={img5} alt=""className='w-[100%] h-[500px] my-20 rounded-[40px]' />
              </div>
              <div className="stat-sec5 text-[#ffff] flex ">
                 <div className="stat-item-sec5 ">
                        <span className='sp-sec5'>01</span><br />
                        <span className='sp-sec55 text-[24px]'>Research</span><br />
                        <span className="sp-sec555  text-[12px] leading-[16.8px]">Synthesizing innovative compounds for unmet medical needs.</span>
                    </div>

                      <div className="stat-item-sec5">
                        <span className='sp-sec5'>02</span><br />
                        <span className='sp-sec55  text-[24px]'>Raw Materialsh</span><br />
                        <span className="sp-sec555 text-[12px] leading-[16.8px]">Ethical sourcing of high-purity active pharmaceutical ingredients.</span>
                    </div>
                      <div className="stat-item-sec5">
                        <span className='sp-sec5'>03</span><br />
                        <span className='sp-sec55  text-[24px]'>Manufacturing</span><br />
                        <span className="sp-sec555 text-[12px] leading-[16.8px]">Advanced synthesis and formulation under sterile conditions.</span>
                    </div>
                      <div className="stat-item-sec5">
                        <span className='sp-sec5'>04</span><br />
                        <span className='sp-sec55  text-[24px]'>Quality Control</span><br />
                        <span className="sp-sec555 text-[12px] leading-[16.8px]">Multi-tier testing for purity, stability, and efficacy.</span>
                    </div>  

                    <div className="stat-item-sec5">
                        <span className='sp-sec5'>05</span><br />
                        <span className='sp-sec55  text-[24px]'>Packaging</span><br />
                        <span className="sp-sec555 text-[12px] leading-[16.8px]">Multi-tier testing for purity, stability, and efficacy.</span>
                    </div>

                    <div className="stat-item-sec5">
                        <span className='sp-sec5'>06</span><br />
                        <span className='sp-sec55  text-[24px] '>Distribution</span><br />
                        <span className="sp-sec555 text-[12px] leading-[16.8px]">Multi-tier testing for purity, stability, and efficacy.</span>
                    </div>
              </div>
        </div>
      ...
      <div className="section6 py-[100px] bg-[#0001]">
        <div className="container">
            ...
            <div className="content-sec6 my-4 flex gap-4 ">
                <div className="info-content w-[392px] h-[350px] bg-[#ffff] rounded-[40px]">
      ...
      <div className="section7 bg-[#E2E3E1] w-[100%] h-[740px]">
        <div className="container flex">
            ...
            <div className="border-img-sec7 my-25 w-[707px] h-[495px] bg-white rounded-[24px] relative">
                 ...
                 <p className='absolute top-[250px] left-[175px] text-[#2D2E80] text-[14]'>Network across Middle East, Africa, and Europe</p>
        ...
        <div className="container relative w-full h-[545px]">
            <div className="info-sec8 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
               ...
               <div className="btn-sec8 flex items-center justify-center gap-4 mt-10 ">
                <button className='w-[206px] h-[54px] rounded rounded-[999px] bg-[#E2E3F0] text-[#2D2E80] text-[14px]'>Global Inquiries</button>
                <button className='w-[206px] h-[54px] rounded rounded-[999px] border border-[#E2E3F0] text-[#2D2E80] text-[14px] text-white'>Join Our Team</button>
               </div>
            </div>
        </div>
      </div>
        ...
        <div className="container ">
            ...
            <div className="info2-sec9 flex gap-15  ">
                    <div className="col1-sec9 space-y-5 ">
                        ...
                        <p className='text-[16px] text-[#3F4948] font-Regular'>Privacy Policy</p>
                        <p className='text-[16px] text-[#3F4948] font-Regular'>Terms of Service</p>
                        <p className='text-[16px] text-[#3F4948] font-Regular'>Compliance</p>
                    </div>
                    <div className="col2-sec9 space-y-5 ">
                        <p className='text-[14px] text-[#575E70] font-semibold'>SUPPORT</p>
                        <p className='text-[16px] text-[#3F4948] font-Regular'>Pharmacovigilance</p>
                        <p className='text-[16px] text-[#3F4948] font-Regular'>Global Offices</p>
                        <p className='text-[16px] text-[#3F4948] font-Regular'>Contact</p>
                    </div>
                </div>
            </div>
        </div>
                    <div className="w-[100%] h-[1px] border border-[#BFC8C833] my-10"></div>
                    <p className='text-center text-[#3F4948] text-[12px] my-[-10px]'>© 2024 Marcyrl Pharmaceutical Industries. Excellence in Healthcare.</p>
      </div>
      </div>
    </div>
  )
